...
{
    public class NegociationFeastRepository : BaseRepository<Negociation_Feast>, INegociationFeastRepository
    {
        public NegociationFeastRepository(Lo2maContext DbCon) : base(DbCon)
        {
        }
    }
}
