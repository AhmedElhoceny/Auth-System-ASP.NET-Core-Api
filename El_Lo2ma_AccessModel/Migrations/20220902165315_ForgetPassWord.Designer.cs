...
namespace El_Lo2ma_AccessModel.Migrations
{
    ...
    [Migration("20220902165315_ForgetPassWord")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("El_Lo2ma_DomainModel.Models.Auth.AuthCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("El_Lo2ma_DomainModel.Models.Auth.RefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("El_Lo2ma_DomainModel.Models.Auth.UserType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ExpirationTime = 24.0,
                            InsertDate = new DateTime(2022, 9, 2, 18, 53, 15, 13, DateTimeKind.Local).AddTicks(8319),
                            IsDeleted = false,
                            Licenses = "",
                            Name = "Admin",
                            UpdateDate = new DateTime(2022, 9, 2, 18, 53, 15, 13, DateTimeKind.Local).AddTicks(8331)
                        },
                        new
                        {
                            Id = 2,
                            ExpirationTime = 8.0,
                            InsertDate = new DateTime(2022, 9, 2, 18, 53, 15, 13, DateTimeKind.Local).AddTicks(8334),
                            IsDeleted = false,
                            Licenses = "شهادة صحية , صور البطاقة",
                            Name = "Chief",
                            UpdateDate = new DateTime(2022, 9, 2, 18, 53, 15, 13, DateTimeKind.Local).AddTicks(8334)
                        },
                        new
                        {
                            Id = 3,
                            ExpirationTime = 24.0,
                            InsertDate = new DateTime(2022, 9, 2, 18, 53, 15, 13, DateTimeKind.Local).AddTicks(8335),
                            IsDeleted = false,
                            Licenses = "رخصة قيادة , صور البطاقة",
                            Name = "Delivery",
                            UpdateDate = new DateTime(2022, 9, 2, 18, 53, 15, 13, DateTimeKind.Local).AddTicks(8336)
                        },
                        new
                        {
                            Id = 4,
                            ExpirationTime = 8.0,
                            InsertDate = new DateTime(2022, 9, 2, 18, 53, 15, 13, DateTimeKind.Local).AddTicks(8336),
                            IsDeleted = false,
                            Licenses = "",
                            Name = "Client",
                            UpdateDate = new DateTime(2022, 9, 2, 18, 53, 15, 13, DateTimeKind.Local).AddTicks(8337)
                        });
                });
            ...
            modelBuilder.Entity("El_Lo2ma_DomainModel.Models.Auth.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "66992a83-793a-48ce-89e6-6a7aca279dc3",
                            ConcurrencyStamp = "615a6e5a-99ed-4455-8734-b3b42a30a259",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = "40f681db-234a-4b69-8862-5990a83c8aed",
                            ConcurrencyStamp = "328f3f6b-dc29-4dfb-bc58-469baa3fd79e",
                            Name = "Chief",
                            InsertDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            UpdateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = "a87d5c06-4c1a-4a2f-9e0c-ef39ef6f810d",
                            ConcurrencyStamp = "0fee1ea3-daae-4a89-aff6-2a46b33b7359",
                            Name = "Delivery",
                            InsertDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            UpdateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = "e66a9fef-5cbb-4e25-b53f-97af9ccc250a",
                            ConcurrencyStamp = "f3287c21-8848-4036-8894-cf045cfd3a58",
                            Name = "Client",
                            InsertDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            UpdateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
            ...
            modelBuilder.Entity("El_Lo2ma_DomainModel.Models.Auth.ApplicationUserRole", b =>
                {
                    b.HasOne("El_Lo2ma_DomainModel.Models.Auth.ApplicationRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
